        ...
        <div className="flex-1 text-center md:text-left space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
            <div className="flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-xl text-sm font-bold">
              ...
              {profile.role === "Admin" ? "Admin Sistem" : "Staf Keuangan"}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8 relative overflow-hidden flex flex-col h-full">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-800">{profile.role === "Admin" ? "Detail Profil Admin" : "Detail Profil Staf"}</h3>
              <p className="text-slate-400 text-xs font-medium">{profile.role === "Admin" ? "Informasi resmi pengelola sistem KroomBox" : "Informasi resmi staf KroomBox"}</p>
            </div>
          </div>

          <div className="space-y-6 flex-1">
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">{profile.role === "Admin" ? "Nama Lengkap Admin" : "Nama Lengkap Staf"}</label>
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">{profile.role === "Admin" ? "Email Admin" : "Email Staf"}</label>
              <div className="px-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold text-slate-800">
                {profile.email || "-"}
              </div>
            </div>
